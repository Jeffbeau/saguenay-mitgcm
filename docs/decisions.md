...
- **Enfant B réel, résultats (2026-09-26).** Arrêt externe à 87 420 s (98 % des 2 cycles, sans erreur MITgcm) ; 2e cycle exploitable. Cohérence avec le parent (2e cycle, 349 cellules) : amplitude M2 −0,84 % (phase −0,14°), niveau moyen +0,4 cm, salinité 3,4 % → critère < 5 % respecté. Seuil de Sacré-Cœur : col 63,9 m à 50 m (68,5 m NONNA-10, 67,9 m parent), talweg N → E de 12,3 km, col à 7 km. Au col (±1 km) : w rms 3 à 13 mm/s selon la phase (max vers 180-220°, jusant ; minimums près des étales, 90° et 300°), |w| max 63 mm/s. Cellules verticales alternées (~150 m de haut, 300-500 m de large) dans le bassin profond en amont du col (1,5-4 km), surtout au jusant. Nature non hydrostatique à confirmer par l'enfant A.
...
- **Seuil + pointe (2026-09-26, demande de l'utilisateur : étudier ensemble le seuil et le tourbillon de la pointe).** `seuil_nh.py` ajoute : Froude interne au col = |U moyen le long du talweg| / c₁, c₁ = (1/π)∫N dz (mode 1 WKB ; la version 2 couches au plus fort gradient était dominée par la couche saumâtre de surface) ; tourbillon de pointe au niveau ~10 m (max de |ζ| moyen hors de la zone du col, ou --pointe), cœur Okubo-Weiss dans un disque de 1,5 km : circulation, aire, |Ro| (90e centile) ; déphasage de corrélation max Froude → |circulation|. Cas test (col 23 m, courants 2-4 m/s) : Fr médian ~8, sous 1 seulement aux étales.
