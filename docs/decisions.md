...
- **Enfant du mini** (2026-09-25, pour la Config B) : 50 m (rapport 4), emprise UTM x 445,2-455,6 km, y 5328,0-5335,2 km (`utm` dans config.py), 208×144×32 (0,96 M points), faces i = 119..171, j = 11..47 du parent. Premier essai (bbox lon/lat) rejeté sur la vraie bathy : le seuil d'entrée (22,9 m, 69,647°O 48,125°N) tombait à 500 m du bord sud, dans la bande copiée du parent (col faussé à 21,5 m). Seuil maintenant à ~1,9 km du bord sud ; ce bord est dans l'éponge du parent (jusqu'à 5328,8 km), à 11 cellules parent de son OB. Si des effets de bord apparaissent au seuil : étendre le mini vers le sud. Δt 5 s ; éponge 1 km. Estimation : ~1,1 Go, 2 cycles NH ≈ 2 à 3 h sur 2 cœurs.
